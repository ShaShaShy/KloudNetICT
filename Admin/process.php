...
mysqli_query($connection,$sql2);
  ...
  echo "<td><a rel='facebox' href='functions/bill_notProcessed?id=".$row['id']."&userpayment=0'><span class=\"btn btn-danger btn-xs glyphicon glyphicon-eye-open\">UNDO</span> </a> ";
    }else{
  echo "<td><a rel='facebox' href='functions/bill_processed?id=".$row['id']."&userpayment=1'><span class=\"btn btn-success btn-xs glyphicon glyphicon-eye-open\">PAID</span> </a> ";
    };

  echo "<td><a target='_blank' rel='facebox' href='printing?id=".$row['id']."'><span class=\"btn btn-info  btn-xs glyphicon glyphicon-eye-open\">PRINT</span></td>";
  echo "</td>";
  echo "<td><a rel='facebox' href='functions/delbill?id=".$row['id']."'><span class=\"btn btn-dark  btn-xs glyphicon glyphicon-eye-open\">ARCHIVE</span></td>";
  echo "</tr>";
  }
  };
echo "</table>";

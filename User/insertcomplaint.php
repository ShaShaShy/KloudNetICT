...
if(isset($_POST['insertcomplaint']))
{
    ...
    if($conn->connect_error){
        ...
        $stmt = $conn->prepare("insert into complaints(fname,uid,descrip,complaint,status,pnum,addr) values(?,?,?,?,?,?,?)");
        ...
        echo "<script>
        alert('Complaint Has been sent Request will be processed within 24 hours.');
